...
public class Platforms implements Collidable
{
	...
	*/
	public static Node createPlatform(int x, int y, Pane p)
	{
    	...
    	Image img = new Image("https://www.filterforge.com/filters/13302.jpg"); //"https://www.filterforge.com/filters/13302.jpg"
	...
	*/
	public static Node createStaticPlatform(int x, int y, Pane p)
	{
    	...
    	Image img = new Image("https://cartocdn-gusc.global.ssl.fastly.net/opmbuilder/api/v1/map/named/opm-mars-basemap-v0-1/0,1,2,3,4/3/5/3.png"); //https://cartocdn-gusc.global.ssl.fastly.net/opmbuilder/api/v1/map/named/opm-mars-basemap-v0-1/0,1,2,3,4/3/5/3.png");
    	rect.setFill(new ImagePattern(img));
        //rect.setFill(Color.WHITE);
        rect.setStroke(Color.BLACK);
        rect.setTranslateX(x);
